...
* apache: disable mailgraph CGI, use static HTML file generated by cronjob
* postfix: activate mailgraph service by default (not only on packmails)
* postfix: generate mailgraphs with a hourly cronjob that runs a CLI wrapper around the CGI
